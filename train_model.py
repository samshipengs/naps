...
if __name__ == '__main__':
    ...
    numerics, prices, cfilters = test_inputs['numerics'], test_inputs['prices'], test_inputs['cfilters']
    test_predictions = []
    for m, model in enumerate(models):
        ...
        test_pred = model.predict(x=[numerics, prices, cfilters], batch_size=1024)
